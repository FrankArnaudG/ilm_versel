// ============================================
// app/api/produits/[locality]/[brandName]/route.ts
// GET - Liste des modèles filtrés par localité et marque (sans catégorie)
// ============================================
...
export async function GET(
  request: NextRequest,
  { params }: { params: Promise<{ locality: string; brandName: string }> }
) {
  try {
    const { locality, brandName } = await params;
    ...
    const statistics = {
      ...
      // Stockages disponibles (filtrer les null avant le tri)
